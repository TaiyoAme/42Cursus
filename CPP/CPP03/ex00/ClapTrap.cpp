...
/*   Updated: 2024/12/23 19:22:28 by hehuang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string &target)
{
	...
	if (this->energy_point_ == 0)
		...
		std::cout	<< "ClapTrap " << this->name_ << " has no hp left" 
					<< ", attack failed!"<< std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	else if (this->hit_point_ + amount > MAX_HIT)
	{
		std::cout	<< "ClapTrap " << this->name_ << " repair itself and restore "
				<< MAX_HIT - this->hit_point_ << " health point(max)!" << std::endl;
		this->hit_point_ = MAX_HIT;
	}
	else
	{
		std::cout	<< "ClapTrap " << this->name_ << " repair itself and restore "
